...
def apply_clamping(frame, lower_threshold, upper_threshold):
    ...
    # Apply clamping
    gray_frame = np.clip(gray_frame, lower_threshold / 100.0, upper_threshold / 100.0)
...
def update_frame():
    ...
    # Apply clamping
    frame = apply_clamping(frame, lower_threshold, upper_threshold)
...
root = Tk()
root.title("Webcam Video with Clamping")
